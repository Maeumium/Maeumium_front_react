...
const ReceiveBackgrounds = styled.div`
    display: flex;
    width: 390px;
    height: 100vh;
...
export function Receive() {
    return (
        <>
            <ReceiveBackgrounds>
                <ReceiveTitle>이용약관</ReceiveTitle>
                <ReceiveDiv>
                    제1조(목적)<br></br>
                    이 약관은 마음이음 (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
<br></br>제2조(정의)<br></br>
...
<br></br>제15조(서비스의 해제·해지 및 탈퇴 절차)<br></br>
